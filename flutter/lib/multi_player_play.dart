...
class _DrawingAppState extends State<DrawingApp> {
  ...
  void cleanCanvas() {
    signatureGlobalKey1.currentState!.clear();
  }
  ...
  Future<Uint8List> preprocessImage() async {
    if (signatureGlobalKey1.currentState != null) {
      Uint8List signaturePngBytes =
          await signatureToPngImage(signatureGlobalKey1);
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              level,
                              style:
                                  TextStyle(fontFamily: 'game', fontSize: 30),
                            ),
                          ],
                        ),
                        Container(
